...
import 'package:learningapp_flutter/Helpers/validator.dart';
                            ...
                            ElevatedButton(
                              ...
                              onPressed: ()async{
                                if(_formkey.currentState!.validate()){
                                    ...
                                    final Map<String, String>data={"name":_namecontroller.text,"email":_emailcontroller.text,"phone_no":_mobilecontroller.text,"gender":gender,"address":_addresscontroller.text,
                                    "user_category":usercategory,"college_name":_collegecontroller.text,"department":_departmentcontroller.text,"year":studentyear,
